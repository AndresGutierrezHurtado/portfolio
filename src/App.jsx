...
function App() {
  return (
    <>
      <nav className="navbar w-full flex justify-center py-2 fixed z-50">
      ...
      <main className="px-4">
        ...
        <section id="section-inicio" className="py-24 md:py-36 w-full mx-auto container lg:max-w-4xl md:max-w-2xl">
          ...
          <div className="flex gap-6 flex-col sm:flex-row mt-8">
        ...
        <section id="section-proyectos" className=" w-full mx-auto container lg:max-w-4xl md:max-w-2xl">
          ...
          <div className='flex flex-col gap-8 my-5 mb-32'>  
            <Proyectos title="Express Sale" src="/img/express-sale.jpg" lenguages={['PHP', 'Tailwind']} description="Express Sale es un sistema de información para la venta y distribuición de producots de primera necesidad." href="https://express-sale-2024.000webhostapp.com" btn="Sitio Web"/>
            <Proyectos title="Uniformes la abejita 22" src="/img/Abejita22.jpg" lenguages={['Laravel', 'Bootstrap','JQuery']} description="La abejita 22 es un sistema de información para la venta de uniformes escolares." href="https://laabejita22.000webhostapp.com" btn="Sitio Web"/>
            <Proyectos title="Pet's Hoddies" src="/img/pets-hoddies.jpg" lenguages={['React','Node', 'Express']} description="Pet's hoddies es un sistema de información para la venta de ropa y accesorios para mascotas." href="https://petshoddies.000webhostapp.com" btn="Sitio Web"/>
          </div>          
        </section>
