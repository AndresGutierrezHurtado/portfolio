        ...
        return (
            <>
                {lenguages.map((lenguage, index) => (
                    <span key={index} className={`w-fit px-3 py-1 rounded-full ${iconMap[lenguage].color} text-[15px] flex items-center justify-center gap-2 text-black capitalize font-semibold`} >
